...
using Lzma1900DotNetCore.Compress.Exceptions;
using Lzma1900DotNetCore.Compress.Interfaces;
using Lzma1900DotNetCore.Compress.LZMA.Enums;
using Lzma1900DotNetCore.Compress.LZMA.Structs;
using Lzma1900DotNetCore.Compress.LZ.Interfaces;
...
namespace Lzma1900DotNetCore.Compress.LZMA
{
	public class Encoder : ICoder, ISetCoderProperties, IWriteCoderProperties
    {
		...
		UInt32 GetRepLen1Price(State state, UInt32 posState)
		{
			return _isRepG0[state.Index].GetPrice0() +
					_isRep0Long[(state.Index << Base.kNumPosStatesBitsMax) + posState].GetPrice0();
		}

		UInt32 GetPureRepPrice(UInt32 repIndex, State state, UInt32 posState)
		{
			UInt32 price;
			if (repIndex == 0)
			{
		...
		UInt32 GetRepPrice(UInt32 repIndex, UInt32 len, State state, UInt32 posState)
		{
